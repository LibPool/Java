...
- Maven 仓库地址：https://repo.maven.apache.org/maven2/org/apache/sis/parent/
- Maven 坐标：`org.apache.sis:parent`
- pom.xml 引用：`<dependency><groupId>org.apache.sis</groupId><artifactId>parent</artifactId><version>1.6</version></dependency>`
- 源码仓库：https://gitbox.apache.org/repos/asf?p=sis.git
