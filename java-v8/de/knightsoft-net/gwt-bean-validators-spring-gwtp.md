...
- Maven 仓库地址：https://repo.maven.apache.org/maven2/de/knightsoft-net/gwt-bean-validators-spring-gwtp/
- Maven 坐标：`de.knightsoft-net:gwt-bean-validators-spring-gwtp`
- pom.xml 引用：`<dependency><groupId>de.knightsoft-net</groupId><artifactId>gwt-bean-validators-spring-gwtp</artifactId><version>2.5.1</version></dependency>`
