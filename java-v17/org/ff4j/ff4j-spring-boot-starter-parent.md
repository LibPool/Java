...
- Maven 仓库地址：https://repo.maven.apache.org/maven2/org/ff4j/ff4j-spring-boot-starter-parent/
- Maven 坐标：`org.ff4j:ff4j-spring-boot-starter-parent`
- pom.xml 引用：`<dependency><groupId>org.ff4j</groupId><artifactId>ff4j-spring-boot-starter-parent</artifactId><version>2.1</version></dependency>`
