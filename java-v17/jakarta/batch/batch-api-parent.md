...
- Maven 仓库地址：https://repo.maven.apache.org/maven2/jakarta/batch/batch-api-parent/
- Maven 坐标：`jakarta.batch:batch-api-parent`
- pom.xml 引用：`<dependency><groupId>jakarta.batch</groupId><artifactId>batch-api-parent</artifactId><version>2.1.1</version></dependency>`
- 源码仓库：https://github.com/eclipse-ee4j/batch-api
