...
- Maven 仓库地址：https://repo.maven.apache.org/maven2/org/springframework/flex/spring-flex-parent/
- Maven 坐标：`org.springframework.flex:spring-flex-parent`
- pom.xml 引用：`<dependency><groupId>org.springframework.flex</groupId><artifactId>spring-flex-parent</artifactId><version>1.5.2.RELEASE</version></dependency>`
- 源码仓库：https://src.springframework.org/svn/spring-flex
