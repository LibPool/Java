...
- Maven 仓库地址：https://repo.maven.apache.org/maven2/jakarta/batch/tck-parent/
- Maven 坐标：`jakarta.batch:tck-parent`
- pom.xml 引用：`<dependency><groupId>jakarta.batch</groupId><artifactId>tck-parent</artifactId><version>2.1.5</version></dependency>`
- 源码仓库：https://github.com/jakartaee/batch-tck
