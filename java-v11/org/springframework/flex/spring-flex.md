...
- Maven 仓库地址：https://repo.maven.apache.org/maven2/org/springframework/flex/spring-flex/
- Maven 坐标：`org.springframework.flex:spring-flex`
- pom.xml 引用：`<dependency><groupId>org.springframework.flex</groupId><artifactId>spring-flex</artifactId><version>1.5.2.RELEASE</version></dependency>`
